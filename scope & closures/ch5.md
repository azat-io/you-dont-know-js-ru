...
Через тысячу миллисекунд после того, как мы выполнили `wait(..)` и ее внутренней области видимости в ином случае следовало бы исчезнуть, у внутренней функции `timer` все еще есть замыкание на эту область видимости.
